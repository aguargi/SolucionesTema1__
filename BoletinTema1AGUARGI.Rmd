...
De las representaciones que obtenemos, podemos observar que ambos presentan un comportamiento muy similar. 
...
any(is.na(cabbages)) # No se ha encontrado ningún valor perdido.
  ...
  sapply(cabbages, is.na) # No se ha encontrado ningún valor perdido.
```
